            ...
            <div class="row">
                ...
                <div class="row col-md-12">
                    ...
                    <div class="card card-info col-md-10">
                        <!-- form start -->
                        <form action="prosestambahagama88" class="form-horizontal">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="namaAgama" class="col-sm-2 col-form-label">Agama</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="namaAgama" name="namaAgama" placeholder="Nama Agama">
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
