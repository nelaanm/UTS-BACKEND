        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Nabila Zarima</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('/datapenduduk70') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Detail Data</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('/tambah70') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tambah Data</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item menu-open">
                        <li class="nav-item">
                            <a href="{{ url('/logoutuserbaru70') }}" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Logout</p>
                            </a>
                        </li>
